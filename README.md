...
Die vorgestellte Lösung ist eine Minimal Lösung. um aber gerade die Trail-Version noch weiter abzusichern, kann diese parallel noch in der Registry abgelegt werden.
Datei vorhanden?\
       ↓\
Registry vorhanden?\
       ↓\
